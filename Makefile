CC = gcc
SRC = src/args.c src/main.c src/scene.c src/viewer.c src/deserialize/file.c src/deserialize/obj.c src/deserialize/off.c src/deserialize/stdin.c src/deserialize/stl.c src/deserialize/util.c
RAYLIB_VERSION = 5.0
